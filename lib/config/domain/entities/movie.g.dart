...
Id _movieGetId(Movie object) {
  return object.isardID ?? Isar.autoIncrement;
}
...
extension MovieQueryWhereSort on QueryBuilder<Movie, Movie, QWhere> {
  QueryBuilder<Movie, Movie, QAfterWhere> anyIsardID() {
...
extension MovieQueryWhere on QueryBuilder<Movie, Movie, QWhereClause> {
  QueryBuilder<Movie, Movie, QAfterWhereClause> isardIDEqualTo(Id isardID) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterWhereClause> isardIDNotEqualTo(Id isardID) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(
              IdWhereClause.lessThan(upper: isardID, includeUpper: false),
            )
            .addWhereClause(
              IdWhereClause.greaterThan(lower: isardID, includeLower: false),
            );
      } else {
        return query
            .addWhereClause(
  ...
  QueryBuilder<Movie, Movie, QAfterWhereClause> isardIDGreaterThan(Id isardID,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.greaterThan(lower: isardID, includeLower: include),
      );
    });
  }

  QueryBuilder<Movie, Movie, QAfterWhereClause> isardIDLessThan(Id isardID,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.lessThan(upper: isardID, includeUpper: include),
      );
    });
  }

  QueryBuilder<Movie, Movie, QAfterWhereClause> isardIDBetween(
    Id lowerIsardID,
    Id upperIsardID, {
...
extension MovieQueryFilter on QueryBuilder<Movie, Movie, QFilterCondition> {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> isardIDIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> isardIDIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> isardIDEqualTo(Id? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isardID',
        value: value,
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> isardIDGreaterThan(
    Id? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> isardIDLessThan(
    Id? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> isardIDBetween(
    Id? lower,
    Id? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MovieQuerySortThenBy on QueryBuilder<Movie, Movie, QSortThenBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> thenByIsardID() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isardID', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> thenByIsardIDDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isardID', Sort.desc);
    });
  }
...
extension MovieQueryProperty on QueryBuilder<Movie, Movie, QQueryProperty> {
  QueryBuilder<Movie, int, QQueryOperations> isardIDProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isardID');
    });
  }
